...
import { getFaqs, getSiteSettings } from "@/lib/content-api";
...
export default async function FaqPage() {
  const [faqs, siteSettings] = await Promise.all([getFaqs(), getSiteSettings()]);
  return (
    <>
